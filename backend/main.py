...
InvoicePilot: Invoicing SaaS with recurring billing and tax management
"""
...
app = FastAPI(
    title="invoicepilot",
    description="InvoicePilot: Invoicing SaaS with recurring billing and tax management",
    version="1.0.0",
)
